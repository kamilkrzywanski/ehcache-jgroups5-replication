...
public class JGroupsCacheManagerPeerProvider implements ManagedCacheManagerPeerProvider {
    ...
    public static JGroupsCacheManagerPeerProvider getCachePeerProvider(CacheManager cacheManager) {
        ...
        if (!(provider instanceof JGroupsCacheManagerPeerProvider)) {
            LOG.warn("{} for scheme {} cannot be cast to {}.", provider.getClass(),
    ...
    public void init() {
        try {
            if (groupProperties != null) {
                ...
                channel = new JChannel(groupUrl.getFile());
            } else {
        ...
        try {
            ...
            LOG.error("Failed to connect to JGroups cluster '{}', replication will not function. JGroups properties:\n{}", clusterName, this.groupProperties, e);
            this.dispose();
            return;
        }
        ...
        LOG.info("JGroups Replication started for '{}'. JChannel: {}", clusterName, this.channel.toString(true));
    }
        ...
        if (this.channel != null) {
            ...
            if (this.mBeanServer != null) {
                try {
                    ...
                    LOG.error("Error unregistering JGroups channel with MBeanServer under domain " + JMX_DOMAIN_NAME + " with name {}", clusterName, e);
                }
            }
    ...
    public List<CachePeer> listRemoteCachePeers(Ehcache cache) throws CacheException {
        return Objects.requireNonNullElse(this.cachePeersListCache, Collections.emptyList());
    }
