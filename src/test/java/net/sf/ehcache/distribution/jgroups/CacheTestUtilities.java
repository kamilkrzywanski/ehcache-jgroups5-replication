...
public final class CacheTestUtilities {
    ...
    public static final URL ASYNC_CONFIG_URL1 =
            Thread.currentThread().getContextClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager1.xml");
    /**
     * Config file 2
     */
    public static final URL ASYNC_CONFIG_URL2 =
            Thread.currentThread().getContextClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager2.xml");
    /**
     * Config file 3
     */
    public static final URL ASYNC_CONFIG_URL3 =
            Thread.currentThread().getContextClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager3.xml");
    /**
     * Config file 4
     */
    public static final URL ASYNC_CONFIG_URL4 =
            Thread.currentThread().getContextClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager4.xml");
    ...
    public static void waitForReplication(int expectedSize, long maxWait, Ehcache... caches) throws InterruptedException {
        ...
        final List<Ehcache> cacheList = new ArrayList<>(Arrays.asList(caches));
        ...
        for (final Ehcache cache : caches) {
            ...
            if (expectedSize != size) {
                LOG.warn("Cache {} failed to reach expected size {}, size is {}", cache.getName(), expectedSize, size);
            }
        }
